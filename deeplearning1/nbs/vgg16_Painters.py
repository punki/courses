...
def vgg_preprocess(x):
    """
        ...
        Po co? uzylo tej metody normalizacji do wyuczenia tego modelu i z jakiegos powodu trzeba tez tak zrobic
        ze swoimi danymi. Dodatkowo VGG uzylo Cafe ktore uzywa openCv ktore uzywa BGR
...
class Vgg16():
    ...
    def __init__(self, saved_weights=None):
        ...
        self.create(saved_weights=saved_weights)
        self.get_classes()
    ...
    def create(self, saved_weights=None):
        """
    ...
    def ft(self, num, learn_deep):
        """
            ...
            Args:
                ...
                learn_deep: 0 base, how many layers to learn
            Returns:
                None
    ...
    def finetune(self, batches, learn_deep):
        """
            ...
            Args:
                ...
                learn_deep: 0 base, how many layers should we train. 0 will not train any layer
        """
        self.ft(batches.nb_class, learn_deep)
